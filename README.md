...
This list is by no means complete. If you think a company should be added or a description is wrong, please open a PR. Startups are listed in alphabetical order. Most companies could fit multiple categories.

## 📚 Natural language processing

**[Glanos](https://www.glanos.de/)**: Free text analysis for businesses.
...
**[Fast AI Movie](https://fast-ai-movies.com/)**: Movie generation.
...
**[Argo.ai](https://www.argo.ai/)**: Builds the software, hardware, maps, and cloud-support infrastructure to power self-driving vehicles.
...
**[hema.to](https://www.hema.to/)**: Decision support for clinical flow.
...
**[Leevi Health](https://leevi-health.com/)**: Health monitoring for babies.
...
**[OmicEra Diagnostics](https://omicera.com/)**: MS-based proteome analysis to understand human health and disease states.
...
**[dstack.ai](https://dstack.ai/)**: It's like Docker, but for building AI apps in the cloud.

**[TESTIFI](https://testifi.io/)**: Test automation software and tools.
...
**[insaas](https://insaas.ai/)**: AI for market research and product development.
...
**[nebumind](https://www.nebumind.com/)**: Software for manufacturing companies that analyzes, monitors and optimizes the quality of manufactured components.

**[RNA Digital Solutions](https://www.rnadigital.de/)**: Software, AI & simulation for feeding technology.

## 🌱 Environment

**[Fold.ai](https://fold.ai/)**: Forest ecosystem monitoring.

**[OCELL](https://www.ocell.io/)**: Forest management software.
